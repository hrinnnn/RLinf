...
class EnvOutput:
    ...
    def prepare_observations(self, obs: dict[str, Any]) -> dict[str, Any]:
        ...
        reference_start_main_images = obs.get("reference_start_main_images")
        reference_start_wrist_images = obs.get("reference_start_wrist_images")
        ...
        return {
            ...
            "task_ids": task_ids,
            "reference_start_main_images": reference_start_main_images,
            "reference_start_wrist_images": reference_start_wrist_images,
        }
